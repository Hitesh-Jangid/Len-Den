        ...
        update_expense.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((cursor.moveToFirst())){
                    ...
                    AlertDialog.Builder alert = new AlertDialog.Builder(context);
                    alert.setTitle("DailyNeed"); //Set Alert dialog title here
                    alert.setMessage("Update your DailyNeed Details"); //Message here
                    ...
                    final TextView t1 = new TextView(context);
                    final TextView t2 = new TextView(context);
                    t1.setText("Choose DailyNeed Category :");
                    t2.setText("Amount :");
                    final LinearLayout linear = new LinearLayout(context);
                    linear.setOrientation(LinearLayout.VERTICAL);
                    linear.addView(t1);
                    ...
                    alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichButton) {
                            ...
                            // here we convert the input to a string and show in a toast.
                            String amount = input.getEditableText().toString();
                            Toast.makeText(context, "DailyNeed Updated", Toast.LENGTH_LONG).show();
        ...
        view_expense.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(c.moveToFirst() || c.getCount() > 0) {
                    ...
                    builder.setMessage("Expenses for :August" + "- " + year + "\n\nName     Amount     Mark");
