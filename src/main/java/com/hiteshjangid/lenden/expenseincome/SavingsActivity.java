...
public class SavingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final SQLiteDatabase sqLiteDatabase = openOrCreateDatabase("Len-Den",MODE_PRIVATE,null);
        ...
        current_saving.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(c.moveToFirst() || c.getCount() > 0) {
                    ...
                    t1.setText("Target Savings" + String.valueOf(target) +" ₹");
                    t2.setText("Current Savings : " + String.valueOf(savings) +" ₹");
                    final LinearLayout linear = new LinearLayout(context);
                    linear.setOrientation(LinearLayout.VERTICAL);
                    linear.addView(t1);
                    linear.addView(t2);
        ...
        total_saving.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* c=sqLiteDatabase.rawQuery("select sum(e_amount) from expenses where e_mark=1",null);
                ...
                builder.setMessage(String.valueOf(total_saving) + " ₹");
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.cancel();
